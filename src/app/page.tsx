...
export default function Home() {
  ...
  return (
    <div className="text-foreground font-base prose-headings:font-heading prose-h1:2xl:text-6xl prose-h1:xl:text-5xl prose-h1:md:text-5xl prose-h1:sm:text-[33px] prose-h1:text-2xl prose-h2:2xl:text-4xl prose-h2:lg:text-4xl prose-h2:md:text-3xl prose-h2:text-2xl prose-h3:2xl:text-4xl prose-h3:xl:text-3xl prose-h3:lg:text-3xl prose-h3:md:text-2xl prose-h3:sm:text-xl">
        ...
        <div className="mx-auto w-container max-w-full">
          <div className="flex flex-col items-center text-center">
            <h1 className="leading-normal">
              ...
              <span className="relative px-2 sm:mr-2 mr-0 md:[&_svg]:size-[45px] sm:[&_svg]:size-7 bg-main/50 text-main-foreground rounded-base border-2 border-border/40 dark:border-border/70">
                BrutalUI
                <Star9
            ...
            <div className="flex flex-col items-center gap-7 sm:gap-8">
              <div className="flex flex-col items-center gap-3 sm:gap-4">
                <span className="rounded-base border-2 border-border bg-accent px-3 py-1 text-[11px] sm:text-xs font-heading uppercase tracking-[0.25em] text-accent-foreground shadow-shadow">
                  Pick a vibe
                </span>
                <PalettePicker className="max-w-[520px] w-full justify-center" />
              </div>
              <Link
      ...
      <div>
        <MarqueeText
          className="border-t-4 border-border bg-secondary-background md:py-4 py-3"
          direction="left"
          duration={40}
          textSpacing="35px"
        >
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent className="text-sm sm:text-base">
                  ...
                  <a
                    ...
                    href="https://github.com/suyesh/brutal-ui/blob/main/CONTRIBUTING.md"
                  >
                    contributing.md
                  </a>{" "}
                  to get started.
        ...
        <MarqueeText
          className="border-b-4 border-border bg-secondary-background md:py-4 py-3"
          direction="right"
          duration={40}
          textSpacing="35px"
        >
        ...
        <section className="inset-0 w-full flex flex-col items-center justify-center bg-main text-main-foreground bg-[linear-gradient(to_right,#00000033_1px,transparent_1px),linear-gradient(to_bottom,#00000033_1px,transparent_1px)] bg-[size:70px_70px] px-5 lg:py-[200px] md:py-[150px] sm:py-[100px] py-[100px]">
          <h2 className="text-center font-heading not-prose 2xl:text-5xl xl:text-5xl md:text-4xl sm:text-3xl text-[22px] text-main-foreground mb-12">
            Start your BrutalUI project today.
          </h2>
          ...
          {/* <Tabs defaultValue="pnpm" className="max-w-[650px] w-full h-max">
            ...
            <TabsContent value="pnpm">
              <Pre
                __rawstring__="pnpm dlx shadcn@latest init https://brutalui.dev/r/styling/blue.json"
                data-language="bash"
                wrapperClassName="mb-0!"
              >
                <code>
                  <span className="text-white font-bold">pnpm</span>
                  <span className="text-white/[0.53] ">{` dlx shadcn@latest init https://brutalui.dev/r/styling/blue.json`}</span>
                </code>
              </Pre>
            </TabsContent>
            <TabsContent className="**:data-avatar:mb-0" value="npm">
              <Pre
                __rawstring__="npx shadcn@latest init https://brutalui.dev/r/styling/blue.json"
                data-language="bash"
                wrapperClassName="mb-0!"
              >
                <code>
                  <span className="text-white font-bold">npx</span>
                  <span className="text-white/[0.53] ">{` shadcn@latest init https://brutalui.dev/r/styling/blue.json`}</span>
                </code>
              </Pre>
            </TabsContent>
            ...
            <TabsContent value="bun">
              <Pre
                __rawstring__="bunx shadcn@latest init https://brutalui.dev/r/styling/blue.json"
                data-language="bash"
                wrapperClassName="mb-0!"
              >
                <code>
                  <span className="text-white font-bold">bunx</span>
                  <span className="text-white/[0.53] ">{` --bun shadcn@latest init https://brutalui.dev/r/styling/blue.json`}</span>
                </code>
              </Pre>
            </TabsContent>
          </Tabs> */}
