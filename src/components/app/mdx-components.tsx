...
import Styling from "@/app/styling/styling"
...
export const sharedComponents = {
  ...
  TabsTrigger: ({
    ...
    <TabsTrigger
      className={cn(
        "h-full border-0 border-r-2 z-10 border-r-border rounded-none sm:text-base data-[state=active]:text-foreground text-foreground last:border-r-0",
        className,
      )}
      {...props}
    />
