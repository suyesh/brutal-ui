...
export default function HeroComponents({
  ...
  return (
    ...
    >
      <VerticalMarquee
        reverse={reverse}
        className="w-full max-w-full h-full pr-3"
      >
        <CardExample />
        <AlertExample />
        <AccordionExample />
...
function VerticalMarquee({
  ...
  return (
    <div className={cn("overflow-hidden", className)}>
      <div
        className={cn(
          "flex flex-col gap-5 animate-marquee-up",
...
const ResizableExample = () => (
  ...
  >
    <ResizablePanel tabIndex={-1} defaultSize={50}>
      <div className="flex h-full items-center justify-center bg-main text-main-foreground p-6">
...
const CollapsibleExample = () => (
  <Collapsible className="w-full space-y-2">
    ...
    <CollapsibleContent className="space-y-2 text-foreground font-base">
      <div className="rounded-base border-2 border-border bg-main text-main-foreground px-4 py-3 font-mono text-sm">
        @radix-ui/colors
      </div>
      <div className="rounded-base border-2 border-border bg-main text-main-foreground px-4 py-3 font-mono text-sm">
        @stitches/react
